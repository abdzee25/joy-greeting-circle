  ...
  return (
    <div className="mx-auto max-w-4xl px-4 sm:px-6 py-10">
      <div className="text-center mb-8">
        ...
        <h1 className="mt-3 text-3xl sm:text-4xl font-bold tracking-tight">Your AI Health Companion</h1>
      ...
      <div className="rounded-2xl border border-border bg-card shadow-[var(--shadow-card)] overflow-hidden">
        <div ref={scrollRef} className="h-[480px] overflow-y-auto p-6 space-y-4">
          {history.length === 0 && !loading && (
            <div className="flex h-full flex-col items-center justify-center text-center text-muted-foreground">
              ...
              <p className="text-sm">Try: "I have a sore throat, mild fever and headache for 2 days."</p>
            </div>
          )}
        ...
        <form onSubmit={submit} className="border-t border-border bg-background p-3 flex gap-2">
          <input
            value={input}
